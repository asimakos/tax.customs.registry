...
<html>
<head>
	<title>Καταχώρηση &nbsp; ΑΦΜ &nbsp; ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ &nbsp;Ληπτών &nbsp; Τιμολογίων</title>
...
<p align="center">
<font size="+1">
Παρακαλώ επιλέξτε εάν υπάρχουν λήπτες ή όχι 
για τον συγκεκριμένο εκδότη.
</font>
<br>
<br>
...
<p align="center">
<font size="+1"> <b> Παρακαλώ εισάγετε τα ΑΦΜ των ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ ληπτών ένα κάθε φορά στο αντίστοιχο
...
<TD>&nbsp;&nbsp;
<INPUT Type="button" value="Καταχώρηση &nbsp; ΑΦΜ" onclick="duplsave_afm();">
</TD>
