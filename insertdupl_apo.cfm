...
<CFSTOREDPROC 
procedure="insert_duplicate_publisher" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="insert_dupl_timologia" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="insert_duplicate_publisher_user" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Καταχώρησης &nbsp; Διπλών&nbsp;Εκδοτών &nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="insert.cfm">&nbsp; Καταχώρηση &nbsp;διπλών&nbsp;εκδοτών &nbsp; τιμολογίων </a> &nbsp; / &nbsp;
Αποτελέσματα διπλών εκδοτών τιμολογίων κατά ΑΦΜ
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΗΣ ΕΓΓΡΑΦΗΣ με επωνυμία εκδότη &nbsp;&nbsp;#FORM.epwnymia# &nbsp;&nbsp; καταχωρήθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΗΣ ΕΓΓΡΑΦΗΣ με επωνυμία εκδότη #FORM.epwnymia# <h2> δεν </h2> καταχωρήθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
