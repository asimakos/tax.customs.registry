...
<CFSTOREDPROC 
procedure="update_history_publisher" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="update_history_publisher_user" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Ενημέρωσης &nbsp;ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ&nbsp; Εκδοτών  &nbsp; Τιμολογίων</title>
</head>
...
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp;
<a href="find.cfm"> Ενημέρωση &nbsp; ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων </a>
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΗΣ ΕΓΓΡΑΦΗΣ με επώνυμο εκδότη &nbsp;&nbsp;#FORM.epwnymia# &nbsp;&nbsp; ενημερώθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΗΣ ΕΓΓΡΑΦΗΣ με επωνυμο εκδότη #FORM.epwnymia# <h2> δεν </h2> ενημερώθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
