...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; <a href="n_essay.cfm"> Αναζήτηση ληπτών τιμολογίων με αριθμό εκθέσεων ελέγχου υπόθεσης </a>
 &nbsp; /  &nbsp; Αποτελέσματα ληπτών τιμολογίων με αριθμό εκθέσεων ελέγχου υπόθεσης </font>
</p>
