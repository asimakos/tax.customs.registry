...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Δραστηριότητα  &nbsp;Εκδοτών&nbsp; Τιμολογίων  </title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση εκδοτών τιμολογίων με Δραστηριότητα
</font>
</p>


<p align="center">
<cfform name="form_afm" action="ergasia_apo.cfm" method="post">
