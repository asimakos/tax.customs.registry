...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; (Όνομα - Επώνυμο)  &nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="epwnymia.cfm">&nbsp; Αναζήτηση εκδοτών τιμολογίων με Όνομα - Επώνυμο </a> &nbsp; / &nbsp;
Αποτελέσματα εκδοτών τιμολογίων με Επωνυμία: 
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει αυτό το όνομα - επώνυμο  στην λίστα εκδοτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει αυτό το όνομα - επώνυμο  στην λίστα εκδοτών!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτό το όνομα - επώνυμο, υπάρχει &nbsp;ΔΙΠΛΟ &nbsp; στην λίστα εκδοτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί εκδότες τιμολογίων που επίσης πληρούν την επωνυμία αυτή!</b></font></p>
</cfif>
<br>
<hr>
<br>
