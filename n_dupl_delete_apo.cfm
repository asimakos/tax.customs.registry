...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Επιβεβαίωση &nbsp; διαγραφής &nbsp; ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ ληπτών &nbsp; τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; <a href="n_timh.cfm"> Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Ληπτών &nbsp; Τιμολογίων </a>
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ λήπτη:&nbsp;&nbsp; #FORM.element# &nbsp;&nbsp;διαγράφτηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το ΑΦΜ ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ λήπτη:&nbsp;&nbsp; #FORM.element# <h2> δεν </h2> διαγράφτηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
