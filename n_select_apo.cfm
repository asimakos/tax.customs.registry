...
<CFSTOREDPROC 
procedure="find_dupl_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; ΑΦΜ &nbsp;Ληπτών&nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="n_select.cfm">&nbsp; Αναζήτηση ληπτών τιμολογίων κατά ΑΦΜ </a> &nbsp; / &nbsp;
...
<p align="center"><font style="Arial"><b>Υπάρχει το ΑΦΜ αυτό στην λίστα ληπτών!</b></font></p>
<br>
...
<a href="n_report.cfm?id1=#Trim(form.t_afm)#&amp;id2=#Trim(date_id)#"> 
...
<p align="center"><font style="Arial"><b>Επίσης αυτό το ΑΦΜ, υπάρχει &nbsp;ΔΙΠΛΟ &nbsp; στην λίστα ληπτών!</b></font></p>
<br>
...
<TD class="#Class#"> 
<cftooltip tooltip="Εμφάνιση Αναφοράς">
<a href="n_duplreport.cfm?id1=#Trim(form.t_afm)#&amp;id2=#Trim(id_epix)#"> 
<img src="../plasta/images/report.jpg" width="30" height="30" border="1" hspace="15"> 
</a> 
</cftooltip>
