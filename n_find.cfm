...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Εμφάνιση &nbsp;Ληπτών &nbsp;Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση Ληπτών τιμολογίων κατά ΑΦΜ
</font>
</p>
...
μεταβολής ληπτών! Συμπληρώστε την <a href="javascript:void(0);" onclick="open_request();"> <b>φόρμα </b></a> για αποστολή των απαιτούμενων
