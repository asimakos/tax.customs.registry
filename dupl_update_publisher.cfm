...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ενημέρωση &nbsp; ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Εκδοτών &nbsp;Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση &nbsp;ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων
</font>
</p>

<cfif cust.recordcount EQ 0>

<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν ΔΙΠΛΕΣ ΕΓΓΡΑΦΕΣ  εκδοτών που πληρούν το ΑΦΜ αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="dupl_update_apo.cfm" method="post" onsubmit="return update_data();">
<div align="center"><font style="Arial" size="4"><b>
Ενημέρωση &nbsp;ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Εκδοτών &nbsp; Τιμολογίων</b></font>
</div>
<br>
