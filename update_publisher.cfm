...
<CFSTOREDPROC 
procedure="find_single_publisher" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="find_single_user_publisher" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ενημέρωση  &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Εκδοτών &nbsp;Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν εγγραφές εκδοτών που πληρούν το ΑΦΜ αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="update_apo.cfm" method="post" onsubmit="return update_data();">
<div align="center"><font style="Arial" size="4"><b>
Ενημέρωση &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Εκδοτών &nbsp; Τιμολογίων</b></font>
</div>
...
<!---
<TD>
<font style="Arial" size="3">Πληθός  στοιχείων:  &nbsp;</font>
