...
<CFSTOREDPROC 
procedure="epwnymia_data_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="epwnymia_dupldata_smuggler" 
datasource="plasta"
returncode="Yes">
...
<!---
<CFSTOREDPROC 
procedure="epwnymia_data_user_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="epwnymia_dupl_user_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; (Όνομα - Επώνυμο)  &nbsp; Λαθρεμπόρων</title>
</head>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="telepwnymia.cfm">&nbsp; Αναζήτηση Λαθρεμπόρων με Όνομα - Επώνυμο </a> &nbsp; / &nbsp;
Αποτελέσματα Λαθρεμπόρων με Όνομα - Επώνυμο: 
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει αυτό το όνομα - επώνυμο  στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει αυτό το όνομα - επώνυμο  στην λίστα Λαθρεμπόρων!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτό το όνομα - επώνυμο, υπάρχει &nbsp;ΔΙΠΛΟ &nbsp; στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί λαθρέμποροι που επίσης πληρούν την επωνυμία αυτή!</b></font></p>
</cfif>
