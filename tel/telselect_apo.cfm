...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Στοιχείων (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) &nbsp; Λαθρεμπόρων</title>
</head>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="telselect.cfm">&nbsp; Αναζήτηση Λαθρεμπόρων κατά Στοιχεία </a> &nbsp; / &nbsp;
...
<p align="center"><font style="Arial"><b>Υπάρχει το Στοιχείο αυτό στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
...
<p align="center"><font style="Arial"><b>Επίσης αυτό το Στοιχείο, υπάρχει &nbsp;ΔΙΠΛΟ &nbsp; στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
