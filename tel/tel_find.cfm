...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Στοιχεία (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) &nbsp; Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση Λαθρεμπόρων κατά Στοιχεία (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος)
</font>
</p>
...
μεταβολής λαθρεμπόρων! Συμπληρώστε την <a href="javascript:void(0);" onclick="open_request();"> <b>φόρμα </b></a> για αποστολή των απαιτούμενων
...
<br>
<cfinput type="button" name="del" value="'Ελεγχος" onclick="userupdate();">
&nbsp;&nbsp;&nbsp;
...
<br>
<br>
<cfform name="form_afm" action="telupdate.cfm" method="post">
<font face="Arial" size="3">
Εισαγωγή &nbsp; Στοιχείου (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος):&nbsp;
</font>
<cfinput type="text" 
name="u_afm" 
onFocus="setu_Color();"
onBlur="setoldu_Color();"
Message="Παρακαλώ εισάγετε μια έγκυρη τιμή για ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος!" 
required="Yes">
&nbsp;
&nbsp;
&nbsp;
