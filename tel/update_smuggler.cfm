...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ενημέρωση  &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Λαθρεμπόρων
</font>
</p>
...
<cfform name="form_data" action="telupdate_apo.cfm" method="post" onsubmit="return telupdate_data();">
<div align="center"><font style="Arial" size="4"><b>
Ενημέρωση &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</b></font>
</div>
