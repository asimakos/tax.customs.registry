...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - (Όνομα - Επώνυμο) &nbsp;Λαθρεμπόρων </title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση Λαθρεμπόρων με Όνομα - Επώνυμο: 
</font>
</p>


<p align="center">
<cfform name="form_afm" action="telepwnymia_apo.cfm" method="post">
<font face="Arial" size="3">
Εισαγωγή &nbsp; Όνομα - Επώνυμο:&nbsp;
</font>
<cfinput type="text" 
name="t_afm" 
onFocus="set_Color();"
