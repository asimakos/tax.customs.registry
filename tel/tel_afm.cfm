...
<html>
<head>
	<title>Καταχώρηση &nbsp; Στοιχείων (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) &nbsp; Συνυπαιτίων</title>
...
<p align="center">
<font size="+1"> <b> Παρακαλώ εισάγετε όποια στοιχεία γνωρίζετε που αφορούν το ΑΦΜ συνυπαιτίου σε λαθρεμπορία, τον
...
<TD>&nbsp;&nbsp;
<INPUT Type="button" value="Καταχώρηση &nbsp; Στοιχείων" onclick="save_afm();">
</TD>
