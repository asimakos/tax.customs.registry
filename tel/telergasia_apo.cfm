...
<CFSTOREDPROC 
procedure="ergasia_data_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupldata_smuggler" 
datasource="plasta"
returncode="Yes">
...
<!---
<CFSTOREDPROC 
procedure="ergasia_data_user_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupl_user_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Δραστηριότητας &nbsp; Λαθρεμπόρων</title>
</head>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="telergasia.cfm">&nbsp; Αναζήτηση Λαθρεμπόρων με Δραστηριότητα </a> &nbsp; / &nbsp;
Αποτελέσματα Λαθρεμπόρων με Δραστηριότητα
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει η δραστηριότητα αυτή στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει η δραστηριότητα αυτή στην λίστα Λαθρεμπόρων!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτή η δραστηριότητα, υπάρχει &nbsp;ΔΙΠΛΗ &nbsp; στην λίστα Λαθρεμπόρων!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί λαθρέμποροι που επίσης πληρούν την δραστηριότητα αυτή!</b></font></p>
</cfif>
