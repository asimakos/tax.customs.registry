...
<CFSTOREDPROC 
procedure="insert_data_user_culprit" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Καταχώρησης &nbsp; Συνυπαιτίου</title>
</head>
...
--->
&nbsp; Αποτελέσματα Συνυπαιτίου κατά Στοιχεία (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος)
</font>
</p>
...
<p align="center"><font style="Arial"><b>Το στοιχείο με επωνυμία Συνυπαιτίου &nbsp;&nbsp;#FORM.epwnymia# &nbsp;&nbsp; καταχωρήθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το στοιχείο με επωνυμία Συνυπαιτίου #FORM.epwnymia# <h2> δεν </h2> καταχωρήθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
