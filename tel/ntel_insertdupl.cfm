...
<CFSTOREDPROC 
procedure="check_data_user_culprit" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Εισαγωγή &nbsp; Διπλών &nbsp;  &nbsp; Συνυπαίτιων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Εισαγωγή &nbsp;Διπλών &nbsp;Συνυπαίτιων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν στοιχεία στην λίστα συνυπαίτιων!</b></font></p>

<cfelse>

<cfform name="form_data" action="ntel_insertdupl_apo.cfm" method="post" onsubmit="return duplinsert_select();">
...
<cfinclude template="ntel_insertnewdupl.cfm">
