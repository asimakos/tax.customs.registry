...
<CFSTOREDPROC 
procedure="find_single_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Διαγραφή  &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Λαθρεμπόρων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν εγγραφές λαθρεμπόρων που πληρούν το στοιχείο (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="teldelete_apo.cfm" method="post" onsubmit="return teldelete_data();">
<div align="center"><font style="Arial" size="4"><b>
Διαγραφή &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</b></font>
</div>
...
required="yes" value="#Trim(cust.epwnymia)#" disabled="disabled" onFocus="set_field1();" onBlur="setold_field1();"> 
</TD>
