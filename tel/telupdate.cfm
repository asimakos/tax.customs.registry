...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ενημέρωση &nbsp; Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση &nbsp;Λαθρεμπόρων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει το στοιχείο (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) αυτό στην λίστα λαθρεμπόρων!</b></font></p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί λαθρέμποροι που επίσης πληρούν το στοιχείο (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) αυτό!</b></font></p>
