...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Εμφάνιση &nbsp;Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή Λαθρεμπόρων κατά Στοιχεία (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) 
</font>
</p>
<br>
...
διαγραφής λαθρεμπόρων! Συμπληρώστε την <a href="javascript:void(0);" onclick="open_request();"> <b>φόρμα </b></a> για αποστολή των απαιτούμενων
...
<br>
<br>
<cfform name="form_afm" action="teldelete.cfm" method="post">
