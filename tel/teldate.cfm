...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ημερομηνία &nbsp; καταχώρησης &nbsp; Λαθρεμπόρων  </title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση λαθρεμπόρων κατά Ημερομηνία
</font>
</p>


<cfform name="date_sel" action="telreportdate.cfm" method="post" onsubmit="return date_select();">
<table bgcolor="#00ffff">
<TR>
<TH> <font size="+1">Υπηρεσία &nbsp; καταχώρησης &nbsp; λαθρέμπορου: </font> </TH>
<TD> 
<cfoutput>
