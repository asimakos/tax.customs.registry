...
<CFSTOREDPROC 
procedure="insert_data_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="insert_data_user_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Καταχώρησης &nbsp; Λαθρεμπόρων</title>
</head>
...
Αποτελέσματα Λαθρεμπόρων κατά Στοιχεία (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος)
</font>
</p>
...
<p align="center"><font style="Arial"><b>Το στοιχείο με επωνυμία Λαθρεμπόρου &nbsp;&nbsp;#FORM.epwnymia# &nbsp;&nbsp; καταχωρήθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το στοιχείο με επωνυμία  Λαθρεμπόρου #FORM.epwnymia# <h2> δεν </h2> καταχωρήθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
