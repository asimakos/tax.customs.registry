...
<html>
<head>
	<title>Καταχώρηση &nbsp; αιτήματος &nbsp; μεταβολής &nbsp; ή &nbsp;διαγραφής &nbsp; λαθρεμπόρου</title>
...
φόρμα  για μεταβολή ή διαγραφή λαθρέμπορου χρησιμοποιώντας το κουμπί της καταχώρησης. </b></font>
</p>
</cfoutput>
