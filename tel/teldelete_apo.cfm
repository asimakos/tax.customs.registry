...
<CFSTOREDPROC 
procedure="insert_history_smuggler" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="delete_data_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Επιβεβαίωση &nbsp; διαγραφής &nbsp; Λαθρεμπόρου &nbsp;</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; <a href="tel_timh.cfm"> Διαγραφή &nbsp; Λαθρεμπόρου </a>
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το στοιχείο Λαθρεμπόρου:&nbsp;&nbsp; #FORM.element# &nbsp;&nbsp;διαγράφτηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το στοιχείο Λαθρεμπόρου:&nbsp;&nbsp; #FORM.element# <h2> δεν </h2> διαγράφτηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
