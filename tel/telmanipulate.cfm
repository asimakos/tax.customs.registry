...
<font size="+1">
<b>
Αιτήματα  επεξεργασίας - διαγραφής  λαθρεμπόρων  Περιφερειακών  Διευθύνσεων 
</b>
</font>
</p>
<br>
...
bind="cfc:del.getrequests({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
onchange="cfc:del.editrequests({cfgridaction},{cfgridrow},{cfgridchanged})">
