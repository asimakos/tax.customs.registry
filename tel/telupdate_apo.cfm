...
<CFSTOREDPROC 
procedure="update_data_smuggler" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Ενημέρωσης &nbsp; Λαθρεμπόρων </title>
</head>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; <a href="tel_find.cfm"> Ενημέρωση &nbsp; Λαθρεμπόρων </a>
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το στοιχείο με επώνυμο λαθρέμπορου &nbsp;&nbsp;#FORM.epwnymia# &nbsp;&nbsp;ενημερώθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το στοιχείο με επώνυμο λαθρέμπορου #FORM.epwnymia# <h2> δεν </h2> ενημερώθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
