...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αριθμός &nbsp; εκθέσεων &nbsp; ελέγχου &nbsp; υπόθεσης &nbsp; λαθρεμπόρων </title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση λαθρεμπόρων με αριθμό εκθέσεων ελέγχου υπόθεσης
</font>
</p>


<cfform name="date_sel" action="telreportessay.cfm" method="post" onsubmit="return date_select();">
...
<TR>
<TH> <font size="+1">Υπηρεσία &nbsp; σύνταξης &nbsp; εγγράφου &nbsp; λαθρέμπορου: </font> </TH>
<TD> 
<cfoutput>
...
<TH valign="top">
<font size="+1">
Διάστημα &nbsp;ημερομηνίας &nbsp;σύνταξης &nbsp;εγγράφου &nbsp;λαθρέμπορου:&nbsp;&nbsp;
</font>
</TH>
