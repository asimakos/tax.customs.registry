...
<head>
	...
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Καταχώρηση &nbsp;Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Καταχώρηση &nbsp; Λαθρεμπόρων
</font>
</p>

<font style="Arial" size="4"><b>
Καταχώρηση &nbsp; Λαθρεμπόρων </b></font>
...
<cfset REQUEST.apotel_action="tel_check.cfm">
<cfset REQUEST.apotel_sub="return insert_select();">

<cfelse>

<cfset REQUEST.apotel_action="telnewinsert_apo.cfm">
