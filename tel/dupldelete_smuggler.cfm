...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</title>
...
<font size="2">
<a href="telmain.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Λαθρεμπόρων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλές εγγραφές λαθρεμπόρων που πληρούν το στοιχείο (ΑΦΜ,ΑΔΤ,Διαβατήριο,Αρ.Κυκλ.Οχήματος) αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="teldupldelete_apo.cfm" method="post" onsubmit="return teldelete_data();">
<div align="center"><font style="Arial" size="4"><b>
Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Λαθρεμπόρων</b></font>
</div>
...
required="yes" disabled="disabled" value="#Trim(cust.epwnymia)#" onFocus="set_field1();" onBlur="setold_field1();"> 
</TD>
...
required="yes" disabled="disabled" value="#Trim(cust.titlos)#"
...
<TR>
<TD width="200">
<font style="Arial" size="3">Κωδικός &nbsp; ΔΟΥ: &nbsp;  </font>
