...
τα αντίστοιχα στοιχεία που αφορούν το πλήθος των στοιχείων, την καθαρή αξία και
το ποσό του ΦΠΑ για κάθε μια περίδο και χρησιμοποιήστε το κουμπί Καταχώρηση για
...
<cfinput type="text" name="stoixeia" 
message="Παρακαλώ εισάγετε μια έγκυρη τιμή για πλήθος στοιχείων!"
validate="integer"
required="yes"
maxlength="10">
...
message="Παρακαλώ εισάγετε μια έγκυρη τιμή για ποσό ΦΠΑ!"
validate="integer"
required="yes"
maxlength="10">
...
<cftextarea name="results" cols="80" rows="5" 
multiple="yes" 
