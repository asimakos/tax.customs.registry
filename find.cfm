...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση εκδοτών τιμολογίων κατά ΑΦΜ
</font>
</p>
...
μεταβολής εκδοτών! Συμπληρώστε την <a href="javascript:void(0);" onclick="open_request();"> <b>φόρμα </b></a> για αποστολή των απαιτούμενων
...
<br>
<br>
<cfform name="form_afm" action="update.cfm" method="post">
