...
<br>
<br>
Δικαιώματα &nbsp; διαγραφής &nbsp; εγγραφών &nbsp; εκδοτών &nbsp; και&nbsp; ληπτών &nbsp; διαθέτει &nbsp;
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Διαγραφή &nbsp;Ληπτών &nbsp; Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή &nbsp;Ληπτών &nbsp; Τιμολογίων
</font>
</p>
...
<cftooltip tooltip="Εμφάνιση Φόρμας Διαγραφής">
<a href="delete_receiver.cfm?id1=#Trim(r_afm)#&amp;id2=#Trim(date_id)#">
...
<cftooltip tooltip="Εμφάνιση Φόρμας Διαγραφής">
<a href="delete_receiver.cfm?id1=#Trim(r_afm)#&amp;id2=#Trim(date_id)#&amp;id3=#Trim(REQUEST.use)#">
<img src="../plasta/images/delete.jpg" border="1" width="30" height="30" hspace="15">
</a>
</cftooltip>
...
<TD class="#Class#"> 
<cftooltip tooltip="Εμφάνιση Φόρμας Διαγραφής">
<a href="dupl_delete_receiver.cfm?id1=#Trim(form.t_afm)#&amp;id2=#Trim(id_epix)#"> 
