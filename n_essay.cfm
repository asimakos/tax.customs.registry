...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αριθμός &nbsp; εκθέσεων &nbsp; ελέγχου &nbsp; υπόθεσης &nbsp; ληπτών </title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση ληπτών τιμολογίων με αριθμό εκθέσεων ελέγχου υπόθεσης
</font>
</p>


<cfform name="date_sel" action="n_reportessay.cfm" method="post" onsubmit="return date_select();">
...
<TR>
<TH> <font size="+1">Υπηρεσία &nbsp; σύνταξης &nbsp; εγγράφου &nbsp; λήπτη: </font> </TH>
<TD>
<cfoutput>
...
<TH valign="top">
<font size="+1">
Διάστημα &nbsp;ημερομηνίας &nbsp;σύνταξης &nbsp;εγγράφου &nbsp;λήπτη:&nbsp;&nbsp;
</font>
</TH>
