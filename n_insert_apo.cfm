...
<CFSTOREDPROC 
procedure="insert_data_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="insert_data_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Καταχώρησης &nbsp;Ληπτών &nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="n_insert.cfm">&nbsp; Καταχώρηση &nbsp; ληπτών &nbsp; τιμολογίων </a> &nbsp; / &nbsp;
...
<p align="center"><font style="Arial"><b>Το ΑΦΜ με επώνυμο λήπτη &nbsp;&nbsp; #FORM.epwnymia# &nbsp;&nbsp; καταχωρήθηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το ΑΦΜ με επώνυμο λήπτη #FORM.epwnymia# <h2> δεν </h2> καταχωρήθηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
