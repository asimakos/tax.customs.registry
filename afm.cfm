...
<html>
<head>
	<title>Καταχώρηση &nbsp; ΑΦΜ &nbsp; Ληπτών &nbsp; Τιμολογίων</title>
...
<p align="center">
<font size="+1"> <b> Παρακαλώ εισάγετε τα ΑΦΜ των ληπτών ένα κάθε φορά στο αντίστοιχο
...
<TD>&nbsp;&nbsp;
<INPUT Type="button" value="Καταχώρηση &nbsp; ΑΦΜ" onclick="save_afm();">
</TD>
