...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Διαγραφή ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν ΔΙΠΛΕΣ ΕΓΓΡΑΦΕΣ Εκδοτών Τιμολογίων που πληρούν το ΑΦΜ αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="dupl_delete_apo.cfm" method="post" onsubmit="return delete_data();">
<div align="center"><font style="Arial" size="4"><b>
Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Εκδοτών &nbsp; Τιμολογίων</b></font>
</div>
