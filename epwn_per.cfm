...
<html>
<head>
	<title>ΕΠΩΝΥΜΙΑ ΠΕΙΡΑΜΑΤΙΚΟ</title>
</head>
...
<p align="center"><font style="Arial"><b>Υπάρχει αυτή η επωνυμία στην "ΠΑΛΙΑ" καταχωρημένη λίστα (ACCESS) με τους εκδότες-λήπτες!</b></font></p>
<br>
<table align="center">
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει αυτή η επωνυμία στην "ΠΑΛΙΑ" καταχωρημένη λίστα (ACCESS) με τους εκδότες-λήπτες!</b></font></p>
</cfif>
<br>
