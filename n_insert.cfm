...
<head>
	...
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Καταχώρηση &nbsp;Ληπτών &nbsp; Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Καταχώρηση&nbsp; Ληπτών &nbsp;Τιμολογίων
</font>
</p>

<font style="Arial" size="4"><b>
Καταχώρηση &nbsp; Ληπτών &nbsp; Τιμολογίων</b></font>

<cfoutput>

<cfif Len(#Trim(URL.idafm)#) EQ 0>

<cfset REQUEST.apotel_action="n_check.cfm">
<cfset REQUEST.apotel_sub="return addex_select();">

<cfelse>

<cfset REQUEST.apotel_action="n_newinsert_apo.cfm">
...
<option value="ΩΣ ΠΡΟΣΩΠΟ ΕΙΚΟΝΙΚΑ">ΩΣ &nbsp; ΠΡΟΣΩΠΟ &nbsp; ΕΙΚΟΝΙΚΑ </option>
