...
<CFSTOREDPROC 
procedure="epwnymia_data_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="epwnymia_dupldata_receiver" 
datasource="plasta"
returncode="Yes">
...
<!---
<CFSTOREDPROC 
procedure="epwnymia_data_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="epwnymia_dupl_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; (Όνομα - Επώνυμο) &nbsp;Ληπτών&nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="n_epwnymia.cfm">&nbsp; Αναζήτηση ληπτών τιμολογίων με Όνομα - Επώνυμο  </a> &nbsp; / &nbsp;
Αποτελέσματα ληπτών τιμολογίων κατά ΑΦΜ
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει αυτό το όνομα - επώνυμο στην λίστα ληπτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει αυτό το όνομα - επώνυμο στην λίστα ληπτών!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτό το όνομα - επώνυμο, υπάρχει &nbsp;ΔΙΠΛΟ &nbsp; στην λίστα ληπτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί λήπτες τιμολογίων που επίσης πληρούν την επωνυμία αυτή!</b></font></p>
</cfif>
