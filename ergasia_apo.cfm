...
<CFSTOREDPROC 
procedure="ergasia_data_publisher" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupldata_publisher" 
datasource="plasta"
returncode="Yes">
...
<!---
<CFSTOREDPROC 
procedure="ergasia_data_user_publisher" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupl_user_publisher" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Δραστηριότητας &nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="ergasia.cfm">&nbsp; Αναζήτηση εκδοτών τιμολογίων με Δραστηριότητα </a> &nbsp; / &nbsp;
Αποτελέσματα εκδοτών τιμολογίων με Δραστηριότητα
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει η δραστηριότητα αυτή στην λίστα εκδοτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει η δραστηριότητα αυτή στην λίστα εκδοτών!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτή η δραστηριότητα, υπάρχει &nbsp;ΔΙΠΛΗ &nbsp; στην λίστα εκδοτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί εκδότες τιμολογίων που επίσης πληρούν την δραστηριότητα αυτή!</b></font></p>
</cfif>
