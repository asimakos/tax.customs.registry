...
<html>
<head>
	<title>Καταχώρηση &nbsp; ΑΦΜ &nbsp;ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ &nbsp; Εκδοτών &nbsp; Τιμολογίων</title>
...
<p align="center">
<font size="+1"> <b> Παρακαλώ εισάγετε τα ΑΦΜ των ΔΙΠΛΩΝ ΕΓΓΡΑΦΩΝ εκδοτών ένα κάθε φορά στο αντίστοιχο
...
<TD>&nbsp;&nbsp;
<INPUT Type="button" value="Καταχώρηση &nbsp; ΑΦΜ" onclick="duplnsave_afmtt();">
</TD>
