...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Διαγραφή ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Ληπτών &nbsp; Τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Ληπτών &nbsp; Τιμολογίων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν ΔΙΠΛΕΣ ΕΓΓΡΑΦΕΣ Ληπτών Τιμολογίων που πληρούν το ΑΦΜ αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="n_dupl_delete_apo.cfm" method="post" onsubmit="return delete_data();">
<div align="center"><font style="Arial" size="4"><b>
Διαγραφή &nbsp; ΔΙΠΛΩΝ &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Ληπτών &nbsp; Τιμολογίων</b></font>
</div>
