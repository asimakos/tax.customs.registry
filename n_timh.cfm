...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Διαγραφή ληπτών τιμολογίων κατά ΑΦΜ
</font>
</p>
<br>
...
διαγραφής ληπτών! Συμπληρώστε την <a href="javascript:void(0);" onclick="open_request();"> <b>φόρμα </b></a> για αποστολή των απαιτούμενων
...
<br>
<br>
<cfform name="form_afm" action="n_delete.cfm" method="post">
