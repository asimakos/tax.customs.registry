...
<CFSTOREDPROC 
procedure="ergasia_data_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupldata_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_data_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="ergasia_dupl_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Αποτελέσματα &nbsp; Δραστηριότητας &nbsp;Ληπτών&nbsp; Τιμολογίων</title>
</head>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / <a href="n_ergasia.cfm">&nbsp; Αναζήτηση ληπτών τιμολογίων με Δραστηριότητα </a> &nbsp; / &nbsp;
Αποτελέσματα ληπτών τιμολογίων με Δραστηριότητα
</font>
</p>
<br>
...
<p align="center"><font style="Arial"><b>Υπάρχει η δραστηριότητα αυτή στην λίστα ληπτών!</b></font></p>
<br>
...
<a href="n_report.cfm?id1=#Trim(r_afm)#&amp;id2=#Trim(date_id)#"> 
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχει η δραστηριότητα αυτή στην λίστα ληπτών!</b></font></p>
</cfif>
<br>
<br>
<cfif #dupl_afm.recordcount# GT 0>
<p align="center"><font style="Arial"><b>Επίσης αυτή η δραστηριότητα, υπάρχει &nbsp;ΔΙΠΛΗ &nbsp; στην λίστα ληπτών!</b></font></p>
<br>
...
<cfelse>
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν διπλοί λήπτες τιμολογίων που επίσης πληρούν την δραστηριότητα αυτή!</b></font></p>
</cfif>
