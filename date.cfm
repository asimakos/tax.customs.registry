...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ημερομηνία &nbsp; καταχώρησης &nbsp; Εκδοτών &nbsp;  Τιμολογίων  </title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση εκδοτών τιμολογίων κατά Ημερομηνία
</font>
</p>


<cfform name="date_sel" action="reportdate.cfm" method="post" onsubmit="return date_select();">
<table bgcolor="#00ffff">
<TR>
<TH> <font size="+1">Υπηρεσία &nbsp; καταχώρησης &nbsp; εκδότη: </font> </TH>
<TD> 
<cfoutput>
...
<TH valign="top">
<font size="+1">
Διάστημα &nbsp; ημερομηνίας &nbsp; καταχώρησης:&nbsp;&nbsp;
</font>
</TH>
