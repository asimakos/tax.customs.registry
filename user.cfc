...
<cfcomponent>
    ...
    <cffunction name="terminate" access="public" returntype="void" output="false">
...
<cffunction name="getafm" access="remote">
<cfargument name="afmarg" required="yes">

<cfquery name="afmlist" datasource="epixh">

SELECT * FROM epix
WHERE afm='#Trim(arguments.afmarg)#'
...
<cffunction name="getepwnymia" access="remote">
<cfargument name="epwnarg" required="yes">

<cfquery name="epwnlist" datasource="epixh">

SELECT * FROM epix
WHERE epwnymia LIKE '%#Trim(arguments.epwnarg)#%'
