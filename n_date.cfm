...
<html>
<head>
    <title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Ημερομηνία &nbsp; καταχώρησης &nbsp; Ληπτών &nbsp; Τιμολογίων  </title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Αναζήτηση ληπτών τιμολογίων κατά Ημερομηνία
</font>
</p>


<cfform name="date_sel" action="n_reportdate.cfm" method="post" onsubmit="return date_select();">
<table bgcolor="#00ffff">
<TR>
<TH> <font size="+1">Υπηρεσία &nbsp; καταχώρησης &nbsp; λήπτη:</font> </TH>
<TD>
<cfoutput>
