...
<CFSTOREDPROC 
procedure="insert_history_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="delete_data_receiver" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="insert_history_receiver_user" 
datasource="plasta"
returncode="Yes">
...
<CFSTOREDPROC 
procedure="delete_data_user_receiver" 
datasource="plasta"
returncode="Yes">
...
<html>
<head>
	<title>ΣΔΟΕ &nbsp;  Κεντρική &nbsp;  Υπηρεσία - Επιβεβαίωση &nbsp; διαγραφής &nbsp; τιμολογίων</title>
...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; <a href="n_timh.cfm"> Διαγραφή &nbsp; Ληπτών &nbsp; Τιμολογίων </a>
</font>
</p>
<br>
<br>
...
<p align="center"><font style="Arial"><b>Το ΑΦΜ λήπτη:&nbsp;&nbsp #FORM.element# &nbsp;&nbsp;διαγράφτηκε επιτυχώς!</b></font></p>
<cfelse>
<p align="center"><font style="Arial"><b>Το ΑΦΜ λήπτη:&nbsp; &nbsp #FORM.element# <h2> δεν </h2> διαγράφτηκε επιτυχώς!</b></font></p>
</cfif>
</cfoutput>
