...
<font size="2">
<a href="main.cfm">
Κεντρικό μενού </a> &nbsp; / &nbsp; Ενημέρωση  &nbsp;ΕΓΓΡΑΦΩΝ &nbsp;Ληπτών &nbsp; Τιμολογίων
</font>
</p>
...
<p align="center"><font style="Arial"><b><h2> Δεν </h2> υπάρχουν εγγραφές ληπτών που πληρούν το ΑΦΜ αυτό!</b></font></p>

<cfelse>

<cfform name="form_data" action="n_update_apo.cfm" method="post" onsubmit="return nupdate_data();">
<div align="center"><font style="Arial" size="4"><b>
Ενημέρωση  &nbsp; ΕΓΓΡΑΦΩΝ &nbsp; Ληπτών &nbsp; Τιμολογίων</b></font>
</div>
